 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-services__slider ")) new Swiper(".slider-services__slider ", {
            ...
            scrollWatcherIntersecting(entry, targetElement) {
                if (entry.isIntersecting) {
                    ...
                    if (targetElement.classList.contains("footer")) {
                        ...
                        if (srvPageFly) srvPageFly.classList.add("_hide-el");
                    }
                } else {
                    ...
                    if (targetElement.classList.contains("footer")) {
                        ...
                        const srvPageFly = document.querySelector(".srv-page__btn-fly");
                        if (srvPageFly) srvPageFly.classList.remove("_hide-el");
                    }
                }
            }
        ...
        function headerScroll() {
            ...
            document.addEventListener("windowScroll", (function(e) {
                ...
                if (scrollTop >= startPoint) {
                    ...
                    if (flyBtn) !flyBtn.classList.contains("_btn-scroll") ? flyBtn.classList.add("_btn-scroll") : null;
                    if (headerShow) {
                    ...
                    if (flyBtn) flyBtn.classList.contains("_btn-scroll") ? flyBtn.classList.remove("_btn-scroll") : null;
